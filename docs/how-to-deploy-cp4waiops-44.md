...
| cp4waiops.version                     | string | v4.4               | Specify the version of Cloud Pak for AIOps v4.4.
...
| cp4waiops.aiManager.channel         | string | v4.4                                      | The subscription channel for IBM Cloud Pak for AIOps.|
...
| cp4waiops.eventManager.channel      | string | v1.15                                     | The subscription channel for IBM Netcool Operations Insight.|
...
| cp4waiops.eventManager.version        | string | 1.6.11         | The version of IBM Netcool Operations Insight.|
